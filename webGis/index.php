...
<?php
    ...
    // $var_ID = $_GET['ID'];
    // $query = mysqli_query($conn, "DELETE FROM guestbook WHERE ID='$var_ID'"); //mengambil id
    //     if ($query) {
...
.measure-control label {
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container ps-xl-5 ps-lg-4 ps-md-4 ps-sm-2 d-flex align-items-center justify-content-between">

      <a href="index.html" class="logo d-flex align-items-center">
        <img src="../assets/img/logo.png" alt="">
        <h2 class="d-flex align-items-center text-white fw-bolder">KABUPATEN KARANGASEM</h2>
      </a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="index.php" class="active" >PDAM</a></li>
          <li class="dropdown"><a href="#"><span>Statistik & Informasi</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="index.php" class="active">Statistik</a></li>
                ...
                <div class="container py-3 px-4 pb-2 border-0 border-end" style="border: 1px solid black;">
                  ...
                  <table class="table table-hover text-black p-5 caption-top border-top-color">
                    ...
                    <thead class="table-dark">
                      <tr>
                      <th colspan="2" class="th-th">ID - Kecamatan</th>
                  ...
                  <?php } ?> 
                    ...
                    <thead class="table-dark">
                    <tr class="border-0">
                      <th colspan="2o" class="th-th">ID - Kecamatan</th>
                      <th colspan="1" class="th-th text-center">Kode Provinsi</th>
                      <th colspan="1" class="th-th text-center">Kode Kabupaten</th>
                      <th colspan="1" class="th-th text-center">Jumlah Pemakaian</th>
                    </tr>
                  ...
                  <div class="container" data-aos="fade-up">
                    ...
                    <div class="sidebar ps-lg-2">
                      <div class="sidebar-item recent-posts">
                        <h3 class="sidebar-title my-3">Berita Terbaru</h3>
