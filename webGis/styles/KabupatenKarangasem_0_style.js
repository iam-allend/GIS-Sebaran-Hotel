...
var style_KabupatenKarangasem_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("PDAM_2020");
    var labelText = "";
    size = 0;
    var labelFont = "13.0px \'Plus Jakarta Sans SemiBold\', sans-serif";
    ...
    if (value >= 1.000000 && value <= 399788.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 399788.600000 && value <= 471039.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 471039.800000 && value <= 725128.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 725128.600000 && value <= 1108420.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1108420.200000 && value <= 3375735.000000) {
            style = [ new ol.style.Style({
