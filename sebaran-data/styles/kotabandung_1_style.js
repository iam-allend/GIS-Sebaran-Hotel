...
var style_kotabandung_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Jumlah Hotel");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 3.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17.000000 && value <= 47.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 47.000000 && value <= 77.000000) {
            style = [ new ol.style.Style({
