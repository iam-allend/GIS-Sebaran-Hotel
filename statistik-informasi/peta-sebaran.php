...
<?php
    ...
    $ambil_data = mysqli_query($conn, "SELECT * FROM tb_jumlah_hotel ORDER BY ID"); // mengurutkan data
    $ambil_data2 = mysqli_query($conn, "SELECT * FROM tb_jumlah_hotel ORDER BY ID"); // mengurutkan data
    ...
    $var_ID = $_GET['ID'];
    $query = mysqli_query($conn, "DELETE FROM tb_jumlah_hotel WHERE ID='$var_ID'"); //mengambil id
        if ($query) {
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            <h5 class="m-0 font-weight-bold text-success">Tabel Data</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="text-gray-700" class="text-center" style="max-width: 35px;">ID</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-0 my-auto d-flex justify-content-center align-items-center" style="opacity: 1;">
                                                <div class="d-flex flex-wrap-none text-center justify-content-center" style="white-space:none;">
                                                    <?php echo "
                                                        <a href='edit-sebaran.php?ID=$data[ID]' class='p-0 my-1 btn-success btn-icon-split'>
